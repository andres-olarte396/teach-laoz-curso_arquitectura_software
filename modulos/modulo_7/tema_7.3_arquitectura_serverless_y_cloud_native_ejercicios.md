# EJERCICIOS: TEMA 7.3 - Arquitectura Serverless y Cloud Native
...
**Pregunta**: Explica con tus propias palabras qué es Arquitectura Serverless y Cloud Native y por qué es importante.
